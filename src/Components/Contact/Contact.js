...
function Contact() {
  return (
<div class="  text-center block w-full  p-10 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700" >
...
<a href="mailto: anandmadhavan10201@gmail.com">
  <img src={gmail} alt="Gmail" style={{ width: '70px', height: '70px' }} />
</a>  
<a href="https://github.com/Anand1020-pix" >
<img src={github} alt="GitHub" style={{ width: '70px', height: '70px' }}/>
</a>   
